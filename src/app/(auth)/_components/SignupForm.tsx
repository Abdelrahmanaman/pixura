      ...
      <div className="rounded-3xl border border-transparent p-5 shadow-sm shadow-stone-800 md:mx-auto md:w-[26rem] md:bg-primary/60 md:px-5 md:py-10">
        <div className="mb-4 space-y-2 text-center">
          ...
          <p className="flex items-center justify-center gap-2 text-sm text-muted-foreground">
            Sign up and start creating your own art
            <Sparkle className="inline-block size-4 text-yellow-500" />
          </p>
        </div>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Rick" type="text" {...field} />
                    </FormControl>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Sanchez" type="text" {...field} />
                    </FormControl>
                    <FormMessage className="ml-2" />
                  </FormItem>
                )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      placeholder="GetSchwifty@example.com"
                      type="email"
                      {...field}
                    />
                  </FormControl>
